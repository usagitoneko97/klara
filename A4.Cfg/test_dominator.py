...
class TestDominator(unittest.TestCase):
    ...
    def test_build_dominator_tree_given_1_lvl(self):
        ...
        expected_block_list = common.build_blocks([6, 6, None], [3, 3, None],
                                                  [5, 5, None], [1, 2, None],
    ...
    def test_buld_dominator_tree_given_2_lvl(self):
        as_tree = ast.parse(ms("""\
             z = 2           # 0th block
             while a < 3:    # 1st block
                 if a < 2:   # 2nd block
        ...
        expected_block_list = common.build_blocks([5, 5, None], [4, 4, None], [3, 3, None],
